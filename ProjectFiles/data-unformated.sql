...
INSERT INTO `spade_db`.`companies_has_products` (`companies_id`, `products_id`, `categories_id`) VALUES (2, 2, 2);
INSERT INTO `spade_db`.`companies_has_products` (`companies_id`, `products_id`, `categories_id`) VALUES (2, 3, 1);
INSERT INTO `spade_db`.`companies_has_products` (`companies_id`, `products_id`, `categories_id`) VALUES (2, 4, 2);
INSERT INTO `spade_db`.`companies_has_products` (`companies_id`, `products_id`, `categories_id`) VALUES (3, 1, 1);
INSERT INTO `spade_db`.`companies_has_products` (`companies_id`, `products_id`, `categories_id`) VALUES (3, 3, 2);
INSERT INTO `spade_db`.`companies_has_products` (`companies_id`, `products_id`, `categories_id`) VALUES (3, 5, 1);
INSERT INTO `spade_db`.`companies_has_products` (`companies_id`, `products_id`, `categories_id`) VALUES (4, 2, 2);
INSERT INTO `spade_db`.`companies_has_products` (`companies_id`, `products_id`, `categories_id`) VALUES (4, 3, 1);
INSERT INTO `spade_db`.`companies_has_products` (`companies_id`, `products_id`, `categories_id`) VALUES (4, 4, 2);
